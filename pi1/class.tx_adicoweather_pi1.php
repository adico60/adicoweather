 ...
 *  Copyright notice
 *
 *  (c) 2016 Yann Berton by Juergen Furrer <juergen.furrer@gmail.com>
...
require_once ("typo3conf/ext/adicoweather/pi1/class.yahoo_api_resolver.php");

/**
 * Plugin 'Adico Weather Widget' for the 'yahooweather' extension.
 *
 * @author	Yann Berton by Juergen Furrer <solutionsweb@adico.fr>
 * @package	TYPO3
 * @subpackage	tx_adicoweather
 */
class tx_adicoweather_pi1 extends tslib_pibase {
	var $prefixId = 'tx_adicoweather_pi1';
	// Same as class name
	var $scriptRelPath = 'pi1/class.tx_adicoweather_pi1.php';
	// Path to this script relative to the extension dir.
	var $extKey = 'adicoweather';
	// The extension key.
	...
	function bootstrap() {
		...
		$this->base_path = t3lib_extMgm::siteRelPath('adicoweather');
	...
	function buildMarkerArray($data){
		...
		for ($i = 0; $i <= 4; $i++){
			...
			$markerArray["###item_forecast_".$i."_code###"]     = $markerArray["###item_forecast_".$i."_code###"] ;
	...
	function renderWeather($marker,$mode) {
		...
		if (isset($this->conf['templateFile']))
			...
			$path = 'EXT:adicoweather_dev/template/template.html';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/adicoweather_dev/pi1/class.tx_yahooweather_dev_pi1.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/adicoweather_dev/pi1/class.tx_yahooweather_dev_pi1.php']);
}
?>
